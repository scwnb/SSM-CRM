	...
	<div id="center" style="position: absolute;top: 50px; bottom: 30px; left: 0px; right: 0px;">
		...
		<div id="navigation" style="left: 0px; width: 18%; position: relative; height: 100%; overflow:auto;">
			...
			<ul id="no1" class="nav nav-pills nav-stacked">
				...
				<li class="liClass"><a href="workbench/clue/index.jsp" target="workareaFrame"><span class="glyphicon glyphicon-search"></span> 线索</a></li>
				...
				<li class="liClass"><a href="workbench/chart/transaction/index.jsp" target="workareaFrame"><span class="glyphicon glyphicon-stats"></span> 交易统计图表</a></li>

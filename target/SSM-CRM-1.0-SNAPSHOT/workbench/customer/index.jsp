			...
			<div style="position: relative;top: 10px;">
				<table class="table table-hover">
					...
					<tbody>
						<tr>
							<td><input type="checkbox" /></td>
							<td><a style="text-decoration: none; cursor: pointer;" onclick="window.location.href='workbench/customer/detail.html';">阿里巴巴</a></td>
							<td>zhangsan</td>
							<td>010-84846003</td>
                        ...
                        <tr class="active">
                            <td><input type="checkbox" /></td>
                            <td><a style="text-decoration: none; cursor: pointer;" onclick="window.location.href='detail.jsp';">腾讯</a></td>
                            <td>zhangsan</td>
                            <td>010-84846003</td>
                            <td>http://www.tengxun.com</td>
                        </tr>
					</tbody>
				</table>
			</div>
